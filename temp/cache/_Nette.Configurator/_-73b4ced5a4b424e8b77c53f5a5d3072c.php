...
class SystemContainer extends Nette\DI\Container
{
	...
	public $classes = array(
		'nette\\object' => FALSE, //: nette.cacheJournal, cacheStorage, nette.httpRequestFactory, httpRequest, httpResponse, nette.httpContext, session, nette.userStorage, user, application, nette.presenterFactory, nette.mailer, nette.database, authenticator, authorizator, listRepository, taskRepository, usersRepository, pagesRepository, container,
		...
		'main\\repository' => FALSE, //: listRepository, taskRepository, usersRepository, pagesRepository,
