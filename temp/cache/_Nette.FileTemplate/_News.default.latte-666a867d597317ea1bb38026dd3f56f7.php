<?php //netteCache[01]000387a:2:{s:4:"time";s:21:"0.81755500 1387213258";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:65:"C:\xampp\htdocs\ZURO\app\AdminModule\templates\News\default.latte";i:2;i:1387213254;}i:1;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:10:"checkConst";}i:1;s:25:"Nette\Framework::REVISION";i:2;s:30:"80a7e46 released on 2013-08-08";}}}?><?php

// source file: C:\xampp\htdocs\ZURO\app\AdminModule\templates\News\default.latte

?><?php
// prolog Nette\Latte\Macros\CoreMacros
list($_l, $_g) = Nette\Latte\Macros\CoreMacros::initRuntime($template, '33mo6wmqtj')
;
// prolog Nette\Latte\Macros\UIMacros
//
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbf646037096_content')) { function _lbf646037096_content($_l, $_args) { extract($_args)
...
// block _tableNews
//
if (!function_exists($_l->blocks['_tableNews'][] = '_lb4e2990092e__tableNews')) { function _lb4e2990092e__tableNews($_l, $_args) { extract($_args); $_control->validateControl('tableNews')
	...
	<table class="table table-hover news">
		<thead>
			<tr>
				...
				<th><?php echo Nette\Templating\Helpers::escapeHtml($template->translate("messages.admin.news.translation"), ENT_NOQUOTES) ?></th>
			</tr>
		</thead>
		<tbody>
<?php $iterations = 0; foreach ($allNews as $news): ?>
			<tr>
				...
				<td><?php echo Nette\Templating\Helpers::escapeHtml($template->date($news->news->date, 'j.n.Y H:i:s'), ENT_NOQUOTES) ?></td>
				<td><?php echo Nette\Templating\Helpers::escapeHtml($news->news->users->username, ENT_NOQUOTES) ?></td>
				<td><a href="<?php echo htmlSpecialChars($_control->link("News:editNews", array($news->news_id))) ?>
...
</a> | <a href="<?php echo htmlSpecialChars($_control->link("confirmForm:confirmDelete!", array('id' => $news->news_id, 'title' => $news->title))) ?>
"><i class="glyphicon glyphicon-trash">&nbsp;</i><?php echo Nette\Templating\Helpers::escapeHtml($template->translate("messages.admin.news.delete"), ENT_NOQUOTES) ?></a></td>
				<td class="translated">
					<?php if ($news->news->translated == 1): ?> <?php echo Nette\Templating\Helpers::escapeHtml($template->translate("messages.admin.news.translated"), ENT_NOQUOTES) ?>

					<?php else: ?> <a href="<?php echo htmlSpecialChars($_control->link("News:addTranslation", array($news->news_id))) ?>
"><i class="glyphicon glyphicon-plus-sign">&nbsp;</i><?php echo Nette\Templating\Helpers::escapeHtml($template->translate("messages.admin.news.addTranslation"), ENT_NOQUOTES) ?></a>
<?php endif ?>
				</td>
			</tr>
